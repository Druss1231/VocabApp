...
def chooseWords(r):
     ...
     prompt = "\n".join(
          ...
          f"and all words must be in lowercase and each wordsmust be in one row."
          f"And also change the words to original form if it is in past or plural form." 
          f"here is the list of words: {r}"
          )
